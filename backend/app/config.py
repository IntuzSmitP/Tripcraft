"""
TripCraft configuration — loaded from environment variables.

Provider priority (highest key wins; lower providers are fallbacks):
  1. Gemini  (GEMINI_API_KEY)
  2. OpenRouter  (OPENROUTER_API_KEY)
  3. NVIDIA NIM  (NVIDIA_API_KEY)

To switch providers: just set the relevant API key in .env.
All configured providers are used automatically as fallbacks.
"""
